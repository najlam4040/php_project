...
<body>
   ...
   <div class="container-fluid">
        ...
        <img class=" col-6" src="{{asset ('images/1.jpg')}}" class="img-fluid rounded rounded   mx-auto d-block" alt=""> 
        <!-- <img class="col-2" src="{{asset ('images/1.jpg')}}" class="rounded float-left" alt="...">
         <img class="col-2" src="{{asset ('images/1.jpg')}}" class="rounded float-right" alt="...">
  -->
   </div>
</body>
</html>